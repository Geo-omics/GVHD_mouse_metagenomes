...
plot_increasing_genus <- function(genus_id){
  ...
  ggsave(str_glue("results/day21_more_abund_genera/{current_genus}.png"), width = 4, height = 2, dpi = 600, scale = 1.5)
  ggsave(str_glue("results/day21_more_abund_genera/{current_genus}.pdf"), width = 4, height = 2, dpi = 600, scale = 1.5)
